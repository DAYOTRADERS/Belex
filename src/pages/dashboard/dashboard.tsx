                        ...
                        >
                            {!has_dashboard_strategies && (
                                <Text
                                    ...
                                    weight='bold'
                                >
                                    {localize('Load or Build  Your Bot With DerivHub ')}
                                </Text>
                            )}
                            <Text
                                as='p'
                            ...
                            >
                                {localize(
                                    'Import a bot from your computer or Google Drive, build it from scratch on DerivHub Today and enjoy the benefits of trading with us, or start with a quick strategy.'
                                )}
                            </Text>
                        </div>
